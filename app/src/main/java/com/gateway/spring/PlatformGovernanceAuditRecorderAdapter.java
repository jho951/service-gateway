...
public final class PlatformGovernanceAuditRecorderAdapter implements GatewayAuditRecorder {
    private final AuditLogRecorder delegate;

    public PlatformGovernanceAuditRecorderAdapter(AuditLogRecorder delegate) {
